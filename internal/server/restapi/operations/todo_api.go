...
func NewTodoAPI(spec *loads.Document) *TodoAPI {
	return &TodoAPI{
		...
		TodosAddOneHandler: todos.AddOneHandlerFunc(func(params *todos.AddOneParams, addOneCreated todos.NewAddOneCreatedFunc, addOneInternalServerError todos.NewAddOneInternalServerErrorFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosAddOne has not yet been implemented")
		}),
		TodosDestroyOneHandler: todos.DestroyOneHandlerFunc(func(params *todos.DestroyOneParams, destroyOneNoContent todos.NewDestroyOneNoContentFunc, destroyOneNotFound todos.NewDestroyOneNotFoundFunc, destroyOneInternalServerError todos.NewDestroyOneInternalServerErrorFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosDestroyOne has not yet been implemented")
		}),
		TodosFindHandler: todos.FindHandlerFunc(func(params *todos.FindParams, findOK todos.NewFindOKFunc, findNotFound todos.NewFindNotFoundFunc, findInternalServerError todos.NewFindInternalServerErrorFunc) middleware.Responder {
			return middleware.NotImplemented("operation TodosFind has not yet been implemented")
		}),
		TodosUpdateOneHandler: todos.UpdateOneHandlerFunc(func(params *todos.UpdateOneParams, updateOneOK todos.NewUpdateOneOKFunc, updateOneNotFound todos.NewUpdateOneNotFoundFunc, updateOneInternalServerError todos.NewUpdateOneInternalServerErrorFunc) middleware.Responder {
