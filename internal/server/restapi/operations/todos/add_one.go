...
type AddOneHandlerFunc func(*AddOneParams, NewAddOneCreatedFunc, NewAddOneInternalServerErrorFunc) middleware.Responder

// Handle executing the request and returning a response
func (fn AddOneHandlerFunc) Handle(params *AddOneParams, addOneCreated NewAddOneCreatedFunc, addOneInternalServerError NewAddOneInternalServerErrorFunc) middleware.Responder {
	return fn(params, addOneCreated, addOneInternalServerError)
}

// AddOneHandler interface for that can handle valid add one params
type AddOneHandler interface {
	Handle(*AddOneParams, NewAddOneCreatedFunc, NewAddOneInternalServerErrorFunc) middleware.Responder
}
...
func (o *AddOne) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	res := o.Handler.Handle(Params, NewAddOneCreated, NewAddOneInternalServerError) // actually handle the request
